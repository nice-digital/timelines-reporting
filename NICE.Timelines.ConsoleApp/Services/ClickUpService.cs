...
using NICE.Timelines.ConsoleApp.Models.ClickUp;
using NICE.Timelines.DB;
	...
	public class ClickUpService : IClickUpService
	{
		...
		private async Task<ClickUpTasks> GetTasksInList(string listId)
		{
			var relativeUri = $"list/{listId}/task?"
			                  + "custom_fields=[{\"field_id\":\"" + Constants.ClickUp.Fields.MasterScheduleReportId + "\",\"operator\":\"=\",\"value\":true}]"
